...
**Script:**
> "Our recommendation to the hospital board: implement universal admission screening and contact precautions as the primary intervention — this directly eliminates the dominant driver of endemic prevalence. Supplement with antibiotic stewardship to sustain management of antibiotic selection pressure in high-intensity wards. Maintain hand hygiene improvement as a baseline standard, particularly for its structural effect on R₀ and outbreak risk. The key scientific lesson from this analysis: R₀ and endemic prevalence have different sensitivity profiles, and optimising interventions for prevalence reduction — the metric that matters clinically — requires targeting admission colonisation, not only transmission."
